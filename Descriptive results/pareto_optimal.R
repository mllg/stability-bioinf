#########################################################
# Computation of the pareto optimal models for all three
# data sets for the descriptive experiments
#########################################################
...
names(results_pareto) <- 1:12
save(results_pareto, file = "..\\Descriptive other\\AP Breast Ovary\\results_pareto_BO.RData")

# Pareto optimal results for Stomach
results_pareto <- Map(pf, target1 = "mmce.test.mean", target2 = "mean_size", 
                      target3 = stabilities, dataset = "Stomach")
names(results_pareto) <- 1:12
save(results_pareto, file = "..\\Descriptive other\\Stomach\\results_pareto_St.RData")
